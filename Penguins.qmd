...
viewof Spend_social = Inputs.range(
  [0, 25200], 
  {value: 12000, step: 400, label: "Social Media Spending ($ USD):"}
)
viewof Spend_search = Inputs.range(
  [0, 25200], 
  {value: 12000, step: 400, label: "Paid Search Spending ($ USD):"}
)
viewof Spend_display = Inputs.range(
  [0, 25200], 
  {value: 12000, step: 400, label: "Online Banner & Programmatic Spending ($ USD):"}
)
