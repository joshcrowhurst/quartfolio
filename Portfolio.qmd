...
Inputs.button([
  ...
  ["Optimal Mix", () => {set(viewof Spend_search, 13000), 
                  set(viewof Spend_social, 12000),
                  set(viewof Spend_display, 11000)}]                
                  ])
                  
document.getElementById("formula").innerHTML = "<b>Approved Credit Cards</b> = 80 *ln(<b style='color:#4D77A5;'>" + Number(Spend_search.toFixed(0)) + "</b>) + ln(<b style='color:#F28E2C'>" + (Number(Spend_display.toFixed(0))) + "</b>) + ln(<b style='color:#E15759'>" + (Number(Spend_social.toFixed(0)))+"</b>)"
