---
title: "Josh Crowhurst: Analytics Portfolio <style>.past .slide-background-content {background:#43464B;}</style>"
subtitle: "<b style='color:#4D77A5;'>Insight</b> Communication <b style='color:#4D77A5;'>Implementation</b> Analytics Team Management <br><br><i style='font-style:italic; font-size:0.8em;'>Use arrow keys  &nbsp; ⬅️ ➡️  &nbsp; or swipe to change slide</i>"
format:
  revealjs: 
    theme: default
    slide-number: true
...
:::
# And these are a few <b style='color:#4D77A5;'>recent projects</b> that I am proud of: {background="#43464B"}
...
<b>Solution:</b> build a media mix model to estimate the incremental impact of each ad channel. This led to three useful outcomes: 
...
A simplified version of the model*: $Approved Credit Cards = 80 * \ln(Search Spend) + 20 * \ln(Social Spend) + 45 * \ln(DisplaySpend) + 130$
...
# I also do a lot of <b style='color:#4D77A5;'>personal projects</b> to keep my analytics skills up-to-date. Here are a couple of those: {background="#43464B"}
<style>
#i-also-do-a-lot-of-personal-projects-to-keep-my-analytics-skills-up-to-date\.-here-are-a-couple-of-those h1 {
    font-size:1.3em;
}
</style>
